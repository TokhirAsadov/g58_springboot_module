...
//                                new ErrorDto(404, request.getRequestURI(), ex.getMessage())
//                        )
//                );
//    }
//
...
////                .body(new BaseResponse<>(
////                                new ErrorDto(400, request.getRequestURI(), errorBody)
////                        )
////                );
////    }
////
...
////                .body(new BaseResponse<>(
////                                new ErrorDto(500, request.getRequestURI(), ex.getMessage())
////                        )
////                );
////    }
//}
